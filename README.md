...
Пакет в каталоге Foundry VTT: https://foundryvtt.com/packages/cosmoboys
...
- [x] Настройка проверки вспышки через D12. Можно найти в: Configure Settings , если отключить, то не будет показывать при броске.
